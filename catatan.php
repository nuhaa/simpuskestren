...
/*
  15 November 2019
  60 Frontend - Shopping Cart Detail
  - membuat cek detail untuk checkout
  - menampilkan detail belanja, modifikasi file views/frontend/cart/index.blade.php

  61 Create a Global Helper for Formatting Ammount
  - pembuatan global helper untuk function rupiah
  - buat file app/helper.php
  - tambahkan autoload di composer.json
  - "files": [
      "app/helpers.php"
  ],
  - kemudian gunakan composer dump-autoload untuk load function nya
  - cara menggunakannya "nama_function(isinya)"
  - contoh ada di file views/frontend/cart/index.blade.php

  62 Frontend - View Chcekout Page

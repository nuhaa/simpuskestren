...
<div class="col-md-8 col-md-offset-2 ">
  <div class="box box-info">
    ...
    <form action="{{ route('medicine.update', $medicine) }}" class="from-horizontal" method="post" >
      @csrf
      @method('PUT')
      <div class="box-body">
        <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
          ...
          <div class="col-md-9">
            <input type="text" name="name" class="form-control" value="{{ old('name') ?? $medicine->name }}" placeholder="Isikan Nama Obat">
            @if ($errors->has('name'))
        ...
        <div class="form-group {{ $errors->has('aturan_pakai') ? 'has-error' : '' }}">
          ...
          <div class="col-md-9">
            <input type="text" name="aturan_pakai" class="form-control" value="{{ old('aturan_pakai') ?? $medicine->aturan_pakai }}" placeholder="Isikan Aturan Pakai nya, Ex:2x1 Sehari">
        ...
        <div class="form-group {{ $errors->has('sasaran') ? 'has-error' : '' }}">
          ...
          <div class="col-md-9">
            <input type="text" name="sasaran" class="form-control" value="{{ old('sasaran') ?? $medicine->sasaran }}" placeholder="Isikan Sasaran, Ex: Dewasa / Anak">
        ...
        <div class="form-group {{ $errors->has('kegunaan') ? 'has-error' : '' }}">
          ...
          <div class="col-md-9">
            <textarea name="kegunaan" rows="2" cols="2" class="form-control" placeholder="Isikan Kegunaan Obat">{{ old('kegunaan') ?? $medicine->kegunaan }}</textarea>
